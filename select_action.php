                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>书籍检索</h3>
                                       ...
                                       <br/>
									   <form action="/select_press_action.php" method="post">
                                        <div class="form-group">
                                            <label>出版社名称</label>
										...
										<br/>
										<form action="/select_kind_action.php" method="post">
                                        <div class="form-group">
                                            <label>上架类别</label>
										...
										<br/>
										<form action="/select_address_action.php" method="post">
                                        <div class="form-group">
                                            <label>馆藏位置</label>
...
<br/>										
									   ...
									   <form action="/select_all_books.php" method="post">
										 <div class="form-group">
										  <h3>图书库</h3>
                                            <label>查看所有图书</label>
									    ...
									    <form action="/select_all_record.php" method="post">
										 <div class="form-group">
										  <h3>记录库</h3>
                                            <label>查看所有借阅历史</label>
